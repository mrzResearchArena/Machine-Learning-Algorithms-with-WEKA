...
public class MainClassV2
{
    ...
    // # 01
    public static void useTrainingData(String trainDataPath, String result) throws Exception
    {

        Formatter out = new Formatter(new File(result));
    ...
    // # 02
    public static void useSuppliedTestingData(String trainDataPath, String testDataPath, String result) throws Exception
    {
    ...
    // # 03
    public static void useCrossValidation(String trainDataPath, int kFolds, String result) throws Exception
    {
    ...
    // # 04
    public static void useSplitingTrainingData(String trainDataPath, double n, String result) throws Exception
    {
        Formatter out = new Formatter(new File(result));
    ...
    public static void actual_VS_predicted(String trainDataPath) throws Exception
    {
        ...
        //String[] options = new String[]{"-C", "0.15", "-M", "5"}; // FOR : J48
        String[] options = new String[]{"-K", "5"}; // FOR : KNN
    ...
    public static void launchClassifications() throws Exception
    {
        ...
        /**
         * Setup path for both train & test dataset
         */
        String trainDataPath = "/home/rafsanjani/Desktop/PR_Class_04/segment_train.arff";
        String testDataPath = "/home/rafsanjani/Desktop/PR_Class_04/segment_test.arff";
        String result = "/home/rafsanjani/Desktop/PR_Class_04/Result.txt";
        ...
        // System.out.println("Train Data Dimension : "+dimention(trainDataPath));
        // System.out.println("Test Data Dimension : "+dimention(testDataPath)+"\n");

        // Calculate Dimension : row x column (Using : Instances):
        // System.out.println("Using : Instances :");
        // System.out.println("Train Data Dimension : "+dimention(train));
        // System.out.println("Test Data Dimension : "+dimention(test)+"\n");


        // Peek only row or column (As, it'll return a vector.)
        // System.out.println(dimention(trainDataPath).elementAt(0));
        // System.out.println(dimention(testDataPath).elementAt(1));
        ...
        // useTrainingData(trainDataPath, result);
        // useSuppliedTestingData(trainDataPath, testDataPath, result);
        // useSplitingTrainingData(trainDataPath, 70, result); // n = trainData in %
        // useCrossValidation(trainDataPath,10, result);
    ...
    public static void debugClassification() throws Exception
    {
        ...
        // Evaluating the model : kFold (Naturally, k=10) CrossValidation
